...
wget https://raw.githubusercontent.com/delta360/PufferPanel-Better-Installer/master/ifiles/dotdeb.gpg -O dotdeb.gpg > /dev/null
apt-key add dotdeb.gpg > /dev/null
rm -rf dotdeb.gpg 
apt-get update > /dev/null
echo "Installing dependencies...";
apt-get install -y openssl curl apache2 git mysql-client mysql-server php5 php5-cli php5-curl php5-mysql php5-mcrypt wget > /dev/null
cd /tmp
...
do
    case $opt in
        "Master (WWW)")
            ...
            wget https://raw.githubusercontent.com/delta360/PufferPanel-Better-Installer/master/ifiles/master.sh -O master.sh > /dev/null
        ...
        "Slave (Scales)")
			...
			wget https://raw.githubusercontent.com/delta360/PufferPanel-Better-Installer/master/ifiles/slave.sh -O slave.sh > /dev/null
